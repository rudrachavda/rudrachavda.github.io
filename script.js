document.addEventListener('DOMContentLoaded', () => {
    ...
    const start = holder.offsetTop; // The point where the image starts
    ...
    window.addEventListener('scroll', () => {
        ...
        if (scrollTop > start && scrollTop < stop) {
            ...
            text.style.top = `${holder.offsetTop + scaledHeight + 20}px`; // Position text
            ...
            text.style.top = `${holder.offsetTop + finalScaledHeight + 20}px`; // Below scaled image
